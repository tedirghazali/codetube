<template>
  <div class="tag:input" @click="focusInput">
    ...
    <input type="text" v-model="tagValue" ref="tagInput" class="tag:input-control" list="tag-list" :placeholder="placeHolder" @input="autoWidth($event), createTag($event)" @keyup.enter="createTag($event)">
